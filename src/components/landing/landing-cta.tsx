...
export function LandingCta() {
  return (
    <section className={styles.closeBand}>
      <Reveal
        className={`${styles.closeCta} relative overflow-hidden px-7 py-16 text-center sm:px-16 sm:py-20`}
      >
        <div
          aria-hidden
        ...
        <h2
          className={`${styles.sectionHeading} relative sm:whitespace-nowrap`}
        >
        ...
        <div className="relative mx-auto mt-8 grid w-full max-w-md grid-cols-2 gap-2.5 sm:mt-10 sm:flex sm:max-w-none sm:flex-wrap sm:items-center sm:justify-center sm:gap-3">
          <TrackedLink
            ...
            eventParams={{ source: "landing_cta" }}
