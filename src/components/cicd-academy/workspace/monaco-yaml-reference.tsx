...
type MonacoYamlReferenceProps = {
  value: string;
  className?: string;
};

function MonacoYamlReferenceInner({
  value,
  className,
}: MonacoYamlReferenceProps) {
...
export const MonacoYamlReference = memo(MonacoYamlReferenceInner);
