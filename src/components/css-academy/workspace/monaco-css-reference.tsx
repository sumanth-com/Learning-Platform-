...
type MonacoCssReferenceProps = {
  value: string;
  className?: string;
};

/**
 * Read-only Monaco CSS viewer — scroll + select/copy only.
 */
function MonacoCssReferenceInner({
  value,
  className,
}: MonacoCssReferenceProps) {
...
export const MonacoCssReference = memo(MonacoCssReferenceInner);
