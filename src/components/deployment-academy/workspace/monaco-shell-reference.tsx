...
type MonacoShellReferenceProps = {
  value: string;
  className?: string;
};

function MonacoShellReferenceInner({
  value,
  className,
}: MonacoShellReferenceProps) {
...
export const MonacoShellReference = memo(MonacoShellReferenceInner);
