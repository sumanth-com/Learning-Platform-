...
type MonacoSqlReferenceProps = {
  value: string;
  className?: string;
};

function MonacoSqlReferenceInner({
  value,
  className,
}: MonacoSqlReferenceProps) {
...
export const MonacoSqlReference = memo(MonacoSqlReferenceInner);
