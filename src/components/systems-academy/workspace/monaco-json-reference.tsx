...
type MonacoJsonReferenceProps = {
  value: string;
  className?: string;
};

function MonacoJsonReferenceInner({
  value,
  className,
}: MonacoJsonReferenceProps) {
...
export const MonacoJsonReference = memo(MonacoJsonReferenceInner);
