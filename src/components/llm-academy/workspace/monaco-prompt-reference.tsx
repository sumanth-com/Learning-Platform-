...
type MonacoPromptReferenceProps = {
  value: string;
  className?: string;
};

function MonacoPromptReferenceInner({
  value,
  className,
}: MonacoPromptReferenceProps) {
...
export const MonacoPromptReference = memo(MonacoPromptReferenceInner);
