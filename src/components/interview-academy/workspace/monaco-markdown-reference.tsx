...
type MonacoMarkdownReferenceProps = {
  value: string;
  className?: string;
};

function MonacoMarkdownReferenceInner({
  value,
  className,
}: MonacoMarkdownReferenceProps) {
...
export const MonacoMarkdownReference = memo(MonacoMarkdownReferenceInner);
